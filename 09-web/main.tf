...
resource "null_resource" "web" {
  ...
  # Bootstrap script will be run on the web instance
  connection {
...
# Create AMI of Web from instance
...
# Create Launch Template for web
